...
{{datosUsuario}}
    ...
    <div class="p-field">
		...
		editMode="cell" class="editable-cells-table" @cellEditComplete="onCellEditComplete" paginatorTemplate="FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink CurrentPageReport RowsPerPageDropdown"  responsiveLayout="scroll" :globalFilterFields="['order_id','trip_id','nombreCliente','coordCargando','horaCargando','horaRuta','coordEntrega','horaEntrega','comentario','tienda','coordRuta','empId','','nombre','coordenadaEntrada','dia'] ">
				...
				<template #right>
					<Button type="button" icon="pi pi-filter-slash" class="p-button-outlined p-mb-2" @click="clearFilter1()" v-tooltip="'Click para borrar filtro'"/>
					</template> 
                        </Toolbar>
                    <Column field="trip_id" header="trip_id" style="min-width:12rem" sortable>
                ...
                <Column field="orders_by_trip" header="orders_by_trip" style="min-width:12rem" sortable>
                 <template #body="slotProps">
                    <div :class="stockClass(slotProps.data)">
    ...
    <Dialog v-model:visible="operadorDialog" :style="{width: '980px'}" header="Pedidos" class="p-fluid">
            ...
            <Column field="order_id" header="order_id">
            <template #body="slotProps">
                    <div :class="stockClass(slotProps.data)">
            ...
            <Column field="nombreCliente" header="nombreCliente">
            <template #body="slotProps">
                    <div :class="stockClass(slotProps.data)">
            ...
            <Column field="horaCargando" header="horaCargando">
            <template #body="slotProps">
                    <div :class="stockClass(slotProps.data)">
            ...
            <Column field="coordCargando" header="coordCargando">
            <template #body="slotProps">
                    <div :class="stockClass(slotProps.data)">
            ...
            <Column field="horaRuta" header="horaRuta">
            <template #body="slotProps">
                    <div :class="stockClass(slotProps.data)">
            ...
            <Column field="coordRuta" header="coordRuta">
            <template #body="slotProps">
                    <div :class="stockClass(slotProps.data)">
            ...
            <Column field="horaEntrega" header="horaEntrega">
            <template #body="slotProps">
                    <div :class="stockClass(slotProps.data)">
            ...
            <Column field="coordEntrega" header="coordEntrega">
            <template #body="slotProps">
                    <div :class="stockClass(slotProps.data)">
...
export default ({
    ...
    await this.asignacionTiendaServicio.getEmpId(localStorage.usuario).then(data=>{
       ...
       //console.log(this.asigEmpId,"cps");
        this.viajesServicio.getAll().then(data=>{this.viaj=data.data;this.loading=false;
    ...
    methods:{
        async actualizar(){
              await this.viajesServicio.getAll().then(data=>{this.viajes=data.data;this.loading=false; });
        },
        initFilters1() {
				this.filters1 = {
...
stockClass(data) {
 ...
 onProductSelect(event) {
        ...
        async Info(operador){
            ...
            await this.pedidosServicio.findTripId(this.operador.trip_id ).then(data=>{this.pedidos=data.data;this.loading=false; });
